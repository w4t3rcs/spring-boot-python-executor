...
public class CachingPythonProcessor implements PythonProcessor {
    ...
    /**
     * Processes the given Python script with provided arguments and caches the result.
     * <p>
     ...
     * @param resultClass non-null expected result type
     * @param arguments non-null map of arguments to the script
     * @return result of processing, possibly from cache
